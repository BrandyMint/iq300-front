    ...
    $.Zebra_DatePicker = function(element, options) {
        ...
        var init = function(update) {
            ...
            if (!plugin.settings.always_visible)
                ...
                $(plugin.settings.appendTo).append(datepicker);
...
//                datepicker.trigger("closed");
                if (plugin.settings.onClose != null)
                {
            ...
            if ($.trim(str_date) !== '') {
                ...
                $.each(matches, function(index, match) {
                    ...
                    switch (match.character) {
                        ...
                        case 'D': regexp.push('[a-zа-я]{3}'); break;
                        case 'j': regexp.push('[1-9]|[12][0-9]|3[01]'); break;
                        case 'l': regexp.push('[a-z]+'); break;
                        case 'N': regexp.push('[1-7]'); break;
                        case 'S': regexp.push('st|nd|rd|th'); break;
                        case 'w': regexp.push('[0-6]'); break;
                        case 'F': regexp.push('[a-zа-я]+'); break;
                        case 'm': regexp.push('0[1-9]|1[012]+'); break;
                        case 'M': regexp.push('[a-zа-я]{3}'); break;
                        ...
                        $.each(matches, function(index, match) {
                            ...
                            switch (match.character) {
                                ...
                                case 'M':
                                    ...
                                    else iterable = plugin.settings.monthsInput;
        ...
        var format = function(date) {
            ...
            for (var i = 0; i < plugin.settings.format.length; i++) {
                ...
                switch(chr) {
                    ...
                    // full month name
                    case 'F':
                      result += plugin.settings.monthsInput[n - 1];
                      break;
        ...
        var iframeShim = function(action) {
            ...
            if (browser.name == 'explorer' && browser.version == 6) {
                ...
                if (!shim) {
                    ...
                    $(plugin.settings.appendTo).append(shim);
